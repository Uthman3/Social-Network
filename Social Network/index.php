    ...
    <body>
        <header class="header">
            ...
            <nav class="navbar">
                <ul class="navbar-list">
                    ...
                    <form id="form1" action="results.php" method="get">
                        <input type="text" class="inp" name="user_query" placeholder="Search a Topic" />
        ...
        <div class="content_timelime">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <input type="text" class="title" name="title" id="" placeholder="Write Title"><br>
                <textarea name="content" id="" class="content" cols="50" rows="3" placeholder="Write Description"></textarea><br>
                <input type="file" name="p_image" require="required" value="">
                <select name="topic" class="topic" id="">
                    <option value="">Select a Topic</option>
                    <?php getTopic() ?>

                </select>
                <input type="submit" name="sub" class="post" value="POST">
            </form>
            <?php insertPost() ?>

            <h1>Most Recent Discussion</h1>
