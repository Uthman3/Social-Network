...
<body>
    ...
    <div id="message">
        ...
        <form action="messages.php?u_id=<?php echo $u_id ?>" method="post" id="f">
            <input type="text" name="msg_title" placeholder="Message Subject"><br>
            <textarea name="msg" id="" cols="50" rows="5" placeholder="Message Topic"></textarea><br>
            <input type="submit" style="padding:10px; background:#1662a1;color:#fff;border:none; border-radius:3px;" name="message" value="Send Message">
        </form>
        <br>
        <img style="border:2px solid blue; border-radius:5px;" src="../image/<?php echo $user_image ?>" width="100" height="100" alt="">
        <p><strong><?php echo $user_name ?></strong>is member of this site since: <?php echo $row['user_last_login'] ?>
        </p>
    </div>
