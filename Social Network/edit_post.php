...
<body>
    <header class="header">
        <div class="logo">
            <h2><a href="index copy.php">Facebook 2.0</a></h2>
        </div>
        <nav class="navbar">
            <ul class="navbar-list">
                ...
                <li>
                    <a class="navbar-link" id="profile" href="profile.html" target="_blank">Profile</a>
                </li>
            </ul>
        </nav>
    ...
    padding: 10px;
    margin: 10px 0px;
" value="<?php echo $post_title ?>" /><br>
            <textarea name="content" id="" style="
    padding: 10px;
    margin: 10px 0px;
" cols="83" rows="4"><?php echo $post_con ?></textarea><br>
            <input type="file" name="image" class="image" src="<?php echo $image ?>" alt=""><br>
            <select name="topic" id="" style="
    padding: 10px 10px;
    margin: 10px;
">
            ...
            <input type="submit" name="update" value="Update Post" style="
    padding: 10px;
    background: #222;
    color: #fff;
    font-size: 15px;
...
">
        ...
        if (isset($_POST['update'])) {
            ...
            $update_post = "update posts set post_title='$title', post_content='$content',topic_id='$topic',post_image='$image' where posts_id='$get_id'";
